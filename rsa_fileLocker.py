...
#        self.button2.hide()
        ...
        self.button5 = QPushButton('Resister', self)
...
#        self.button2.hide()
    ...
    def login(self):
        ...
        pas = pas.strip()
        filepath='C:/Users/Amanullah Asraf/Desktop/filelocker global/.idea/'+user+'.txt'
        if not os.path.exists(filepath):
            QMessageBox.question(self, 'Message - pythonspot.com', "Not register" , QMessageBox.Ok, QMessageBox.Ok)
            
        else:
            f1 = open(r'C:/Users/Amanullah Asraf/Desktop/filelocker global/.idea/'+user+'.txt', 'r') 
            passw=f1.readline()
            passw = passw.strip()
#            passw=passw.split(' ')[0]
            print(passw)
...
#                print(strs)
    ...
    def register(self):
        ...
        if os.path.exists(filepath):
            ...
            if not pas:
                ...
                f1 = open(r'C:/Users/Amanullah Asraf/Desktop/filelocker global/.idea/'+user+'.txt', 'w') 
                f1.write(pas)
                f1.close
    ...
    def encrypt(self):
        ...
        if self.filename=="":
            ...
            global user
            f = open(r'C:/Users/Amanullah Asraf/Desktop/filelocker global/.idea/'+user+'.txt', "a")
            f.write("\n"+nam)
            f.close()
            filelist.append(nam)
            print(nam)
...
#        self.file_type = textboxValue2
        ...
        if self.filename=="":
            ...
            print(filelist)
            f = open(r'C:/Users/Amanullah Asraf/Desktop/filelocker global/.idea/'+user+'.txt', "w")
            f.write(passw+"\n")
            strs=""
            for x in filelist:
                if strs=="":
